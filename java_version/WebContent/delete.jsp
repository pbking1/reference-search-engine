...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Delete record</h1>
                    <p>Notice: this operation will delete all the record that contain the key you enter.</p>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="panel panel-default">
                        ...
                        <s:form action="delete">  
                            ...
                            <s:submit class="btn btn-lg btn-success btn-block" value = "Delete new record"></s:submit>
                        </s:form>
